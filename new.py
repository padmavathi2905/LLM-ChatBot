...
with st.sidebar:
    ...
    st.markdown("### 📚 Personal Assistant For U")
    st.markdown("---")
...
# Home Page
if choice == "🏠 Home":
    st.title("📄 My Get Ready App")
    st.markdown("""
    Welcome to **Get Ready App**!
    ...
    **Built using Open Source Stack**
    ...
    Enhance your document management experience with my App! 😊
    """)
...
# Contact Page
    ...
    st.title("📬 Contact Us")
    st.markdown("""
    - **Email:** [padmavathikadium1618@gmail.com](mailto:padmavathikadium1618@gmail.com) ✉️
    """)
